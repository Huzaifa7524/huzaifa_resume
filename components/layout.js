      ...
      >
        ...
        <motion.div layoutId="social-icons" className="flex items-center justify-center">
          <a
            ...
            href="https://github.com/Huzaifa7524/"
            target="_blank"
          >
          ...
          <a
            className="text-gray-400 dark:text-white hover:text-lightBlue-600 dark:hover:text-pink-500"
            href="https://twitter.com/huzaifatahir751"
            target="_blank"
          >
          ...
          <a
            className="text-gray-400 dark:text-white hover:text-lightBlue-600 dark:hover:text-pink-500"
            href="https://www.linkedin.com/in/huzaifa-tahir-1808b9242/"
            target="_blank"
          >
